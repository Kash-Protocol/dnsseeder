...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Kash-Protocol/dnsseeder)
...
```bash
$ git clone https://github.com/Kash-Protocol/dnsseeder $GOPATH/src/github.com/Kash-Protocol/dnsseeder
$ cd $GOPATH/src/github.com/Kash-Protocol/dnsseeder
$ go install . 
```
